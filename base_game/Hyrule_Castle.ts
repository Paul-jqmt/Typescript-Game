import { checkHeroLife, displayStat, maximumHealth, playerAttack, playerHeal, classChoosing, questionForPlayer, floorStage, enemiesAttack, baseLink, resetJson} from "./function"
...
{
    resetJson()
    let character_choosed = baseLink()
