...
exports.jsonParse = exports.baseLink = exports.classChoosing = exports.displayStat = exports.maximumHealth = exports.playerHeal = exports.nextFloor = exports.checkHeroLife = exports.playerAttack = exports.enemiesAttack = exports.questionForPlayer = exports.resetJson = exports.character_hp = exports.floorStage = void 0;
var fs = require("fs");
...
function resetJson() {
    var base_data_monster = jsonParse("bokoblincopy.json");
    var base_data_player = jsonParse("playercopy.json");
    fs.writeFileSync("bokoblin.json", JSON.stringify(base_data_monster, null, 2));
...
function enemiesAttack(character) {
    ...
    var data_monster = jsonParse("bokoblin.json");
    var monster_str = 0;
    ...
    if (exports.floorStage < 8) {
        ...
        console.log("Be carefull Ganon is super powerfull... Check your life often if you dont want to die...");
    }
...
function playerAttack(character) {
    ...
    fs.writeFileSync(("bokoblin.json"), JSON.stringify(data_monster, null, 2));
}
...
function displayStat(character) {
    ...
    for (var j = 0; j < data_monster.length; j++) {
        if (data_monster[j].id === exports.floorStage + 1) {
